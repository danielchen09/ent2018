...
<html lang="en">
	...
	<body>
        ...
        <div class="container">
            ...
            <div class="form-group">
                <button type="submit" id="submit" name="redir" value="/personalInfo/medicine.php" class="btn btn-default" onclick="setCount()">Next</button>
                <button type="submit" id="submit" name="redir" value="/profile" class="btn btn-default" onclick="setCount()">Save and exit</button>
            </div>
            </form>
        </div>
	</body>
